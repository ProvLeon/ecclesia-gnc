...
export function Header({ user }: HeaderProps) {
    ...
    return (
        <header className="fixed top-0 right-0 left-0 lg:left-40 lg:pl-30 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800">
